...
bool Character::controlsStateMain = true;
	...
	faceRight(false)
{
	...
	if (!t->loadFromFile("Material/Animations/Entity/getDamage with clothes.png")) {
...
void Character::setControlsState(bool controlsState)
{
	controlsStateMain = controlsState;
}
